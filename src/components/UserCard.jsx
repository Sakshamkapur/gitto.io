...
const UserCard = ({ data }) => {
  ...
  return  <div className="md:w-[10rem] sm:w-full h-50 rounded overflow-hidden shadow-lg bg-gray-100 hover:bg-gray-200 transition duration-300 transform hover:scale-105 cursor-pointer ">
